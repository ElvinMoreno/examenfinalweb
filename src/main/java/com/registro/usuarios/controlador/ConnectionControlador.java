...
import com.registro.usuarios.servicio.ConnectionServicio;
...
@Controller
public class ConnectionControlador {

	@Autowired
	private ConnectionServicio connectionServicio;
	...
	public String showListConnections(Model modelo, Authentication auth) {
		
		String username = auth.getName();
		Usuario usuario = usuarioServicio.selectUsuariobyEmail(username);
		List<Connectiontoken> list = connectionServicio.listConnectiontoken();
